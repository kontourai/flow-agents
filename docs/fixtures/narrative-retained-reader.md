...
`src/cli/narrative-retained-reader.test.mjs` constructs its packed fixture in a
reclaimable temporary directory with the public snapshot, compose, and write
APIs, then reopens it through only the public retained-reader API. It covers
