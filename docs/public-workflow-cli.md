...
identified checkpoint/checkout mismatch. It re-seals the checkpoint against the derived target
checkout's current `HEAD` and requires its attestation companion before copying both into
