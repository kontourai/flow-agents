...
After creating or entering a fresh worktree, run `pnpm install --frozen-lockfile` there before pre-push checks or evals; each worktree needs its own `node_modules`.
