...
CHECKS=(
  ...
  "Publish-change operation integration|bash evals/integration/test_publish_change_operation.sh"
  "Workflow sidecar writer integration|bash evals/integration/test_workflow_sidecar_writer.sh"
  "Builder #1164 head-desync regression integration|bash evals/integration/test_wedge_1164_head_desync.sh"
  ...
  "Stop gate summary record integration|bash evals/integration/test_stop_gate_summary_record.sh"
  ...
  "Console process projection integration|bash evals/integration/test_console_process_projection.sh"
  "Console declared projection integration|bash evals/integration/test_console_declared_projection.sh"
  ...
  "Economics run binding integration|bash evals/integration/test_economics_run_binding.sh"
  ...
  "Builder flow completion integration|bash evals/integration/test_builder_flow_completion.sh"
  "Golden builder.build end-to-end integration|bash evals/integration/test_golden_run_e2e.sh"
  "Effectiveness loop demo integration|bash evals/integration/test_effectiveness_loop_demo.sh"
  ...
  "Builder #830 squash-critique regression integration|bash evals/integration/test_wedge_830_squash_critique.sh"
  ...
  "Hook certification matrix integration|bash evals/integration/test_hook_certification_matrix.sh"
  "Gate certification matrix integration|bash evals/integration/test_gate_certification_matrix.sh"
  "Artifact residue ignored integration|bash evals/integration/test_artifact_residue_ignored.sh"
  "CLI diagnostic quality integration|bash evals/integration/test_cli_diagnostic_quality.sh"
  "Measurement trend sink integration|bash evals/integration/test_measurement_trend.sh"
  ...
  "Global install npx durability integration|bash evals/integration/test_global_install_npx_durability.sh"
...
LANE_SOURCE_AND_STATIC=(
  ...
  "Ablation arm parity unit tests"
...
LANE_RUNTIME_AND_KIT=(
  ...
  "Stop gate summary record integration"
  ...
  "Console process projection integration"
  "Console declared projection integration"
  ...
  "Economics run binding integration"
...
LANE_INTEGRATION_COVERAGE=(
  ...
  "Builder flow completion integration"
  "Golden builder.build end-to-end integration"
  "Effectiveness loop demo integration"
  "Codex hook resolution integration"
  "Critique supersession roundtrip integration"
  "Builder #830 squash-critique regression integration"
  "Lifecycle authority container integration"
  "Dual emit flow step integration"
  "Evidence capture hook integration"
  "Hook certification matrix integration"
  "Gate certification matrix integration"
  "Artifact residue ignored integration"
  "CLI diagnostic quality integration"
  "Measurement trend sink integration"
  "FlowDefinition session history preservation integration"
  "Gate review inquiry records integration"
  "Global install npx durability integration"
