...
if jq -e --arg generated "$GENERATED_AT" '
  ...
  .derivedFrom.directSnapshot.sourceRef == {"product":"flow-agents","kind":"workflow-learning","id":".agents/flow-agents/*/learning.json","label":"Local workflow learning sidecars"} and
  (.learnings | length) == 2
