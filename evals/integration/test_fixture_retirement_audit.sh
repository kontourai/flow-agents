...
[[ "$(json_query "$TMPDIR_EVAL/audit.json" "totals.scanned")" == "18" ]] && pass "audit scans all fixture groups" || fail "audit scans all fixture groups"
...
[[ "$(json_query "$TMPDIR_EVAL/audit.json" "totals.kept")" == "18" ]] && pass "audit keeps all owned fixture groups" || fail "audit keeps all owned fixture groups"
