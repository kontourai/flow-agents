...
require_codeowner "scripts/hooks/lib/effective-flow-agents-config.js" "committed goal-fit hook config resolver"
require_codeowner "context/scripts/hooks/stop-goal-fit.js" "mirrored stop-goal-fit consumer"
require_codeowner "context/scripts/hooks/lib/effective-flow-agents-config.js" "mirrored committed goal-fit config resolver"
require_codeowner "src/li""b/flow-resolver.ts" "src/li""b/flow-resolver.ts"
require_codeowner "src/li""b/trusted-git.ts" "immutable Git blob reader"
require_codeowner "src/li""b/effective-flow-agents-config.ts" "effective config loader"
require_codeowner "schemas/flow-agents-*-config.schema.json" "committed config schemas"
require_codeowner "schemas/codex-pr-review-*.schema.json" "Codex PR review assessment and result schemas"
require_codeowner ".flow-agents/config/" "tracked committed config path"
