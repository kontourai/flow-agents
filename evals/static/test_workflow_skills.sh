...
CONTEXT_MAP_GENERATOR="$ROOT/scripts-ts/generate-context-map.ts"
PACK_FILTER="$ROOT/scripts-ts/filter-installed-packs.ts"
...
require_text "$PAGES_WORKFLOW" 'actions/checkout@v[0-9]+\.[0-9]+\.[0-9]+' "Pages workflow checks out with a pinned semver tag"
require_text "$PAGES_WORKFLOW" 'actions/configure-pages@v[0-9]+\.[0-9]+\.[0-9]+' "Pages workflow configures Pages with a pinned semver tag"
require_text "$PAGES_WORKFLOW" 'actions/jekyll-build-pages@v[0-9]+\.[0-9]+\.[0-9]+' "Pages workflow builds Jekyll docs with a pinned semver tag"
require_text "$PAGES_WORKFLOW" 'actions/upload-pages-artifact@v[0-9]+\.[0-9]+\.[0-9]+' "Pages workflow uploads docs with a pinned semver tag"
require_text "$PAGES_WORKFLOW" 'actions/deploy-pages@v[0-9]+\.[0-9]+\.[0-9]+' "Pages workflow deploys docs with a pinned semver tag"
...
require_text "$CI_WORKFLOW" 'actions/checkout@v[0-9]+\.[0-9]+\.[0-9]+' "CI workflow checks out with a pinned semver tag"
require_text "$CI_WORKFLOW" 'actions/setup-node@v[0-9]+\.[0-9]+\.[0-9]+' "CI workflow sets up Node with a pinned semver tag"
require_text "$CI_WORKFLOW" 'actions/upload-artifact@v[0-9]+\.[0-9]+\.[0-9]+' "CI workflow uploads evidence artifacts with a pinned semver tag"
