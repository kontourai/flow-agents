...
const mirroredFiles = new Map<string, { mirror: string; allowedDifferences: Array<[string, string]> }>([
  ...
  ["scripts/telemetry/lib/kit-identity.sh", { mirror: "context/scripts/telemetry/lib/kit-identity.sh", allowedDifferences: [] }],
