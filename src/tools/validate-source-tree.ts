...
const hookFilePolicies = new Map<string, { category: string; requiredNeedles: string[] }>([
  ...
  ["scripts/hooks/subject-binding.js", { category: "policy hook", requiredNeedles: ["Subject Binding Hook", "FLOW_AGENTS_SUBJECT_BINDING"] }],
  ...
  ["scripts/hooks/lib/subject-binding.js", { category: "shared hook library", requiredNeedles: ["boundSubject", "subjectStatus", "resolveSubjectBindingMode"] }],
  ["scripts/hooks/lib/subject-identity.js", { category: "shared hook library", requiredNeedles: ["workItemSlugResult", "canonicalSubjectKey", "backlogRefsInText"] }],
